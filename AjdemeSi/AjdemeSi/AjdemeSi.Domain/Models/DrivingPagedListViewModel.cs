...
namespace AjdemeSi.Domain.Models
{
    public class DrivingPagedListViewModel : PagedList<AspNetUser>
    {
        public IEnumerable<DrivingViewModel> ListEntries { get; set; }
        ...
        public DrivingPagedListViewModel(IQueryable<AspNetUser> superset, 
                                              int pageNumber, 
                                              int pageSize, 
                                              int totalItemsCount, 
        ...
        {
            ListEntries = mapper.Map<List<DrivingViewModel>>(superset.ToList());
        ...
        public DrivingPagedListViewModel(IEnumerable<AspNetUser> superset, 
                                              int pageNumber, 
                                              int pageSize, 
                                              int totalItemsCount, 
                                              DateTime newestUserCreationDate, 
